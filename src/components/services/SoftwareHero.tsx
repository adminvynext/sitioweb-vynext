            ...
            <div className="container mx-auto px-6 lg:px-12 xl:px-20 py-24 relative z-10">
                <AnimatedSection className="text-center mx-auto">
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-primary">Soluciones Empresariales</span>
                    </motion.div>
                    ...
                    >
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-primary to-gray-700 inline-block">
                            Desarrollo de Software y Sistemas a la Medida en Guatemala
                        </span>
                    </motion.h1>
                    ...
                    >
                        ...
                        <span className="block mt-2 text-gray-500">Automatización, control y escalabilidad para tu empresa.</span>
                    </motion.p>

                    {/* Stats - Changed to be more relevant for software */}
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        <div className="text-center p-6 rounded-2xl bg-primary/5 backdrop-blur-xl border border-primary/20">
                            ...
                            <div className="text-sm text-gray-600 font-medium">Eficiencia Operativa</div>
                        </div>
                        <div className="text-center p-6 rounded-2xl bg-secondary/5 backdrop-blur-xl border border-secondary/20">
                            <div className="text-4xl font-bold text-secondary mb-2">100%</div>
                            <div className="text-sm text-gray-600 font-medium">Personalizable</div>
                        </div>
                        <div className="text-center p-6 rounded-2xl bg-primary/5 backdrop-blur-xl border border-primary/20">
                            <div className="text-4xl font-bold text-primary mb-2">24/7</div>
                            <div className="text-sm text-gray-600 font-medium">Soporte Técnico</div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        >
                            <span className="text-sm font-medium">Descubre nuestras soluciones</span>
