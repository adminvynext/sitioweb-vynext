      ...
      <div className="container mx-auto px-6 lg:px-12 xl:px-20 py-24 relative z-10">
        <AnimatedSection className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <span className="text-sm font-medium text-primary">Planes Todo Incluido</span>
          </motion.div>
          ...
          >
            Encuentra tu{' '}
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-primary to-gray-700 inline-block">Plan Perfecto</span>
          </motion.h1>
          ...
          >
            Soluciones de desarrollo web con modelo <span className="text-primary font-semibold">"Todo Incluido"</span>.
            <span className="block mt-2 text-gray-500">Desarrollo, hosting, dominio y mantenimiento en una sola mensualidad.</span>
          </motion.p>
          ...
          >
            <div className="text-center p-6 rounded-2xl bg-primary/5 backdrop-blur-xl border border-primary/20">
              ...
              <div className="text-sm text-gray-600 font-medium">Planes Disponibles</div>
            </div>
            <div className="text-center p-6 rounded-2xl bg-secondary/5 backdrop-blur-xl border border-secondary/20">
              <div className="text-4xl font-bold text-secondary mb-2">100%</div>
              <div className="text-sm text-gray-600 font-medium">Todo Incluido</div>
            </div>
            <div className="text-center p-6 rounded-2xl bg-primary/5 backdrop-blur-xl border border-primary/20">
              <div className="text-4xl font-bold text-primary mb-2">Q.199</div>
              <div className="text-sm text-gray-600 font-medium">Desde al mes</div>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <span className="text-sm font-medium">Conoce los planes</span>
